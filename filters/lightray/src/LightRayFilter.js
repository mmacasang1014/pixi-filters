import {vertex} from './fragments';
import perlin from './perlin.frag';
import fragment from './lightray.frag';
 ...
 */
class LightRayFilter extends Filter {
    ...
    constructor(options) {
        ...
        if (typeof options === 'number') {
            ...
            console.warn('LightRayFilter now uses options instead of (angle, gain, lacunarity, time)');
